...
import {ShopifySalesChannel, Seo, JudgemeProvider} from '@shopify/hydrogen';
...
export async function loader({request, context}: LoaderArgs) {
  const storeMake = context.env.STORE_MAKE;
  ...
  return (
    <html lang={locale.language}>
      <head>
        ...
        jdgm = window.jdgm || {};
        jdgm.SHOP_DOMAIN = "jeep-gc.myshopify.com";
        jdgm.PLATFORM = 'shopify';
        jdgm.PUBLIC_TOKEN = 'iVFa4cKWdZOQTT2TPVyq6_G_GLU';
        `}}></script>
         <script data-cfasync="false" type="text/javascript" async src="https://cdn.judge.me/widget_preloader.js"/>
         <script data-cfasync="false" type="text/javascript" async src="https://cdn.judge.me/assets/installed.js" />
